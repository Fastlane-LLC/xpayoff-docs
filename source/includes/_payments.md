...
-------------- |---------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------
companyName | `string` :  If `null` we will auto-populate the company name on your account when sent to lender                                                              | N            
